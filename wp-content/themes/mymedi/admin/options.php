...
$option_fields['wishlist'] = array(
	array(
		...
		,'type'     => 'section'
		,'title'    => esc_html__( 'Wishlist Button', 'mymedi' )
		,'subtitle' => ''
		,'indent'   => false
	)
	,array(
		...
		,'type'     => 'switch'
		,'title'    => esc_html__( 'Wishlist in loop', 'mymedi' )
		,'subtitle' => ''
		,'default'  => true
		,'on'		=> esc_html__( 'Show', 'mymedi' )
		,'off'		=> esc_html__( 'Hide', 'mymedi' )
	...
	,array(
		...
		,'type'     => 'switch'
		,'title'    => esc_html__( 'Wishlist on product page', 'mymedi' )
		,'subtitle' => ''
		,'default'  => true
		,'on'		=> esc_html__( 'Show', 'mymedi' )
		,'off'		=> esc_html__( 'Hide', 'mymedi' )
	...
	,array(
		...
		,'type'     => 'switch'
		,'title'    => esc_html__( 'Show wishlist page link after added', 'mymedi' )
		,'subtitle' => esc_html__( 'If disabled, product will be removed from wishlist when clicking button again', 'mymedi' )
		,'default'  => false
	)
	...
	,array(
		...
		,'type'     => 'section'
		,'title'    => esc_html__( 'Wishlist Page', 'mymedi' )
		,'subtitle' => ''
		,'indent'   => false
	)
	,array( 
		...
		,'type'     => 'select' 
		,'title'    => esc_html__( 'Wishlist page', 'mymedi' ) 
		,'subtitle' => esc_html__( 'To show wishlist, use the [ts_wishlist] shortcode', 'mymedi' ) 
		,'desc'     => ''
		,'data'     => 'pages'
		,'default'	=> ''
	)
	,array(
		...
		,'type'     => 'switch'
		,'title'    => esc_html__( 'Remove product from wishlist after added to cart', 'mymedi' )
		,'subtitle' => ''
		,'default'  => true
	)
);
...
$option_fields['compare'] = array(
	array(
		...
		,'type'     => 'section'
		,'title'    => esc_html__( 'Compare Button', 'mymedi' )
		,'subtitle' => ''
		,'indent'   => false
	)
	,array(
		...
		,'type'     => 'switch'
		,'title'    => esc_html__( 'Compare in loop', 'mymedi' )
		,'subtitle' => ''
		,'default'  => true
		,'on'		=> esc_html__( 'Show', 'mymedi' )
		,'off'		=> esc_html__( 'Hide', 'mymedi' )
	...
	,array(
		...
		,'type'     => 'switch'
		,'title'    => esc_html__( 'Compare on product page', 'mymedi' )
		,'subtitle' => ''
		,'default'  => true
		,'on'		=> esc_html__( 'Show', 'mymedi' )
		,'off'		=> esc_html__( 'Hide', 'mymedi' )
	...
	,array(
		...
		,'type'     => 'section'
		,'title'    => esc_html__( 'Compare Page', 'mymedi' )
		,'subtitle' => ''
		,'indent'   => false
	)
	,array( 
		...
		,'type'     => 'select' 
		,'title'    => esc_html__( 'Compare page', 'mymedi' ) 
		,'subtitle' => esc_html__( 'To show compare, use the [ts_compare] shortcode', 'mymedi' ) 
		,'desc'     => ''
		,'data'     => 'pages'
		,'default'	=> ''
	)
	,array(
		...
		,'type'     => 'select'
		,'title'    => esc_html__( 'Fields to show', 'mymedi' )
		,'subtitle' => ''
		,'desc'     => ''
		,'multi'	=> true
		,'sortable'	=> true
		,'options'  => mymedi_get_compare_fields()
