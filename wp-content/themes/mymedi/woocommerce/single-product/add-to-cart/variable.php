	...
	<?php else : ?>
		<div class="variations">
			<?php foreach ( $attributes as $attribute_name => $options ) : ?>
				...
				<?php echo end( $attribute_keys ) === $attribute_name ? wp_kses_post( apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations" href="#" aria-label="' . esc_attr__( 'Clear options', 'mymedi' ) . '">' . esc_html__( 'Clear', 'mymedi' ) . '</a>' ) ) : ''; ?>
			<?php endforeach;?>
